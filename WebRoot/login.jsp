...
<link rel="stylesheet"
	href="<%=basePath%>resources/lib/layui-v2.5.5/css/layui.css"
	media="all">
			...
			<div class="layui-form login-form">
				<form class="layui-form" method="post" action="<%=basePath %>admin/adminLogin">
					...
					<div class="layui-form-item">
						...
						<input type="text" name="aid" lay-verify="required|account"
					...
					<div class="layui-form-item" pane="">
						...
						<input type="radio" name="rol" value=学生 " title="学生"> <input
							type="radio" name="rol" value="管理员" title="管理员">
					</div>
					<div class="layui-form-item">
						<button
