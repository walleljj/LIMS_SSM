                                            ...
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins" id='userNum'>1234</h1>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins" id='teacherNum'>1234</h1>
                                                        <small>当前分类总记录数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins" id="labNum"></h1>
                                                        <small>当前分类总记录数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins" id='exNum'>1234</h1>
                                                        <small>当前分类总记录数</small>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    layui.use(['layer', 'miniTab','echarts','util'], function () {
        var $ = layui.jquery,
            layer = layui.layer,
        ...
        miniTab.listen();
        //document.getElementById("dd").innerHTML=9999999;
        
        $.ajax({
		    url:'<%=basePath%>admin/shuju',      
		    type:"get",
		    data:{},         
		   	success:function(res){
		        console.log(res);
		       document.getElementById("labNum").innerHTML=res.labNum; // 获取或者替换掉html里面的内容
		       document.getElementById("exNum").innerHTML=res.exNum; // 获取或者替换掉html里面的内容
		       document.getElementById("userNum").innerHTML=res.userNum; // 获取或者替换掉html里面的内容
		       document.getElementById("teacherNum").innerHTML=res.teacherNum; // 获取或者替换掉html里面的内容
		    }  
