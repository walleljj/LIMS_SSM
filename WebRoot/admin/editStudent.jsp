...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="sno" type="text" name="sno" lay-verify="required" lay-reqtext="用户名不能为空" placeholder="请输入用户名" readonly="readonly" value="" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block ssex">
            <input  type="radio" name="spwd" value="不重置" title="不重置" checked="">
            <input  type="radio" name="spwd" value="重置" title="重置">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','upload','tableSelect'], function () {
        var form = layui.form,
        	...
        	$('#demo1').attr('src', '<%=basePath%>img/student'+da.sphoto);
